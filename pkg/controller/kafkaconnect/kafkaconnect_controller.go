...
var log = logf.Log.WithName("controller_kafkaconnect")
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &skynetv1alpha1.KafkaConnect{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}

	// TODO(user): Modify this to be the types you create that are owned by the primary resource
	// Watch for changes to secondary resource Pods and requeue the owner KafkaConnect
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &skynetv1alpha1.KafkaConnect{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileKafkaConnect) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	reqLogger.Info("Reconciling KafkaConnect")

	// Fetch the KafkaConnect instance
	instance := &skynetv1alpha1.KafkaConnect{}
	...
	// Set KafkaConnect instance as the owner and controller
...
func newPodForCR(cr *skynetv1alpha1.KafkaConnect) *corev1.Pod {
